...
generateGeneratorMaintenanceReport,
generateParkingPaymentReport } from '../controllers/reportController.js';
...
router.get('/parking-payment', generateParkingPaymentReport);
